...
public final class ${entity.className}Helper {
    ...
    public static ${entity.className} fromCursor(Cursor data) {
        ...
        <#elseif property.propertyType?lower_case == "date">
        entity.set${property.propertyName?cap_first}(new java.util.Date(data.getInt(data.getColumnIndex(${property.propertyName?upper_case}))));
        <#else>
