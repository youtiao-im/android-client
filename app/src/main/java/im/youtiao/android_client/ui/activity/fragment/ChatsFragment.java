 ...
 * <p/>
 * <p/>
 * Activities containing this fragment MUST implement the {@link OnChatsFragmentInteractionListener}
 * interface.
 */
public class ChatsFragment extends RoboListFragment {
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            mListener = (OnChatsFragmentInteractionListener) activity;
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if (null != mListener) {
            ...
            mListener.onChatsFragmentInteraction(DummyContent.ITEMS.get(position).id);
        }
    }
